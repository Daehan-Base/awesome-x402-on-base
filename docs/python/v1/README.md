...
2단계: clients/requests/README.md (동기 클라이언트)
    ↓
3단계: clients/httpx/README.md (비동기 클라이언트)
    ↓
4단계: servers/fastapi/README.md (서버 구현)
    ↓
5단계: discovery/README.md (고급 기능)
```

---

[← 한국어 문서로 돌아가기](../../README.md) | [v2 스펙 보기 →](../../x402-v2-specification.md)
